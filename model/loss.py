...
class GenTargets(nn.Module):
    ...
    def _gen_level_targets(self, out, gt_boxes, classes, stride, limit_range, sample_radiu_ratio=1.5):
        ...
        # 计算每个点到 GT box 的距离，这里的广播机制需要好好想下
        ...
        mask_in_gtboxes = off_min > 0 # 用于筛选在 GT Box 内部的点
        mask_in_level = (off_max>limit_range[0]) & (off_max<=limit_range[1]) # 必须在步长范围内
